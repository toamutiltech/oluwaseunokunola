  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 relative reveal-hidden">
      <div className="absolute top-20 right-10 flex flex-col gap-4 reveal-item reveal-hidden" style={{ transitionDelay: '200ms' }}>
        <a href="https://linkedin.com/in/oluwaseun-okunola-168030a5" target="_blank" rel="noreferrer" className="p-2 glass rounded-full hover:text-blue-400 transition-all hover:scale-110">
          <Linkedin size={20} />
        </a>
        <a href="https://github.com/toamutiltech" target="_blank" rel="noreferrer" className="p-2 glass rounded-full hover:text-blue-400 transition-all hover:scale-110">
          <Github size={20} />
        </a>
        <a href="https://wa.me/2348139669156" target="_blank" rel="noreferrer" className="p-2 glass rounded-full hover:text-green-400 transition-all hover:scale-110">
          <Phone size={20} />
        </a>
      </div>
